...
function Bisection (){
    ...
    useEffect(() => {
       api.getMovieByName("Bisection").then(db => {
    ...
    const bisectionCal = ([fx,xl,xr,er]) => {
      let i=1;
          ...
          <Content style={{ margin: '10px 10px 0' }}>
            ...
            <Row gutter={[8, 40]}>
              <Col className="text-left"  span={24}>
               <h4 >Bisection Method Algorithm</h4>
               <br/>
               <h6>ใส่ fx xr xl</h6>
              </Col>
            </Row>
            ...
            <Row gutter={[8, 48]}>
              ...
              <Col span={6} >
                <Button type="primary" shape="round" icon="stock" size="Large"
                 onClick={()=>bisectionCal([fx,parseFloat(xl),parseFloat(xr),parseFloat(er)])}>
                  Calculate
                </Button>
              </Col>
              <Col span={6} >
